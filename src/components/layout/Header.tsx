...
const TITLES: Record<string, string> = { '/': '心情收支簿', '/ai': 'AI 助手', '/settings': '设置' }
  ...
  return (
    <>
      <header className="flex items-center justify-between h-14 px-4 bg-white/90 dark:bg-gray-900/90 backdrop-blur border-b border-gray-200/50">
        ...
        <button onClick={() => setShowAdd(true)} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-violet-500 to-purple-500 text-white text-sm rounded-2xl hover:from-violet-600 hover:to-purple-600 transition-all shadow-sm">
