...
export default function Settings() {
  ...
  const handleClearAllData = async () => { await db.transactions.clear(); await db.chatMessages.clear(); await db.projects.clear(); await db.categories.clear(); await db.budgets.clear(); await db.jarGoals.clear(); await db.coolDownEvents.clear(); await db.deficits.clear(); await db.settings.clear(); setShowClearConfirm(false); window.location.reload() }
